...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{./images/shor_periodicity.png}
...
\subsubsection{Dalla DFT alla trasformata di Fourier quantistica}
...
\]
è possibile ricostruire il periodo $r$ attraverso l'approssimazione con frazioni continue\footnote{\href{https://learning.quantum.ibm.com/tutorial/shors-algorithm}{IBM Quantum Documentation, Sezione "Fase 3: QFT"}}.
