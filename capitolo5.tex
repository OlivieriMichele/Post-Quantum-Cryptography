...
Uno dei problemi ancora irrisolti nella matematica e informatica teorica è appunto il problema P vs NP, difatti è inserito tra i sette problemi del millennio dal (Clay Mathematic Institute)\footnote{\href{https://www.claymath.org/millennium/p-vs-np/}{Clay Mathematic Institute}}. 
...
\begin{itemize}
    ...
    \item \textbf{Np-hard}: Problemi almeno difficili quanto i problemi più difficili in NP. Formalmente, un problema NP-hard è tale se può essere ridotto in tempo polinomiale a un qualsiasi problema in NP, percui risolvere un problema NP-hard significa dimmostrare che $P = NP$. Esempio: il problema del commesso viaggiatore (TSP).
\end{itemize}
